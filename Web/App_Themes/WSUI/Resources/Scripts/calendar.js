...
function writeIframe()
{
    ...
    "    <table id=tableDay height=120 width=140 border=0 cellspacing=1 cellpadding=0>";
		 ...
		 // ADDED
         strIframe += "<td colspan=2 class=out><input style=' background-color: "+
         WebCalendar.btnBgColor +";cursor: hand; padding-top: 4px; width: 100%; height: 100%; border: 0;' onfocus='this.blur()'"+
         " type=button value='重 置' onclick='parent.onReset()'></td>";
         //
    ...
    "    <tr><td><input name=prevYear title='' onclick='parent.prevY()' type=button value='&lt;&lt;'"+
    "    onfocus='this.blur()' style='meizz:expression(this.disabled=parent.WebCalendar.thisYear==1000)'><input"+
    "    onfocus='this.blur()' name=prevMonth title='' onclick='parent.prevM()' type=button value='&lt;&nbsp;'>"+
    "    </td><td align=center><input name=today type=button value='今 天' onfocus='this.blur()' style='width: 50' title=''"+
    "    onclick=\"parent.returnDate(new Date().getDate() +'/'+ (new Date().getMonth() +1) +'/'+ new Date().getFullYear())\">"+
    "    </td><td align=right><input title='' name=nextMonth onclick='parent.nextM()' type=button value='&nbsp;&gt;'"+
    "    onfocus='this.blur()'><input name=nextYear title='' onclick='parent.nextY()' type=button value='&gt;&gt;'"+
...
function WebCalendar() 
{
    ...
    this.day        = new Array(38);         
    this.dayObj     = new Array(38);         
    this.dateStyle  = null;                   
    this.objExport  = null;     
    this.eventSrc   = null;                  
    this.inputDate  = null;                  
    ...
    this.btnBgColor = "#F3F8FE";  
    this.wordColor  = "#01166F";  
    this.wordDark   = "#DCDCDC";   
    this.dayBgColor = "#F6F6F6";  
    this.todayColor = "#5784BE"; 
    this.DarkBorder = "#F6F6F6";  
...
function returnDate() 
{
    if(WebCalendar.objExport)
    {
        ...
        if(d==null){alert("Redifine WebCalendar.format"); return false;}
