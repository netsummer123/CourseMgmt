...
function showadflow(img, link, winWidth, winHeight){
	//alert(winWidth);
	//alert(winHeight);
...
//debugger
	if (ie){
		document.write("<div ID='allyes' STYLE='position:absolute;left: 10px; top: 10px;' onMouseOver='stop=1;' onMouseOut='stop=0;'>");
		document.write("<a href='javascript://' onclick='window.open(\"" + link + "\", \"popup\", \"width="+ winWidth +", height="+ winHeight +", top="+ iTop +", left="+ iLeft +", scrollbars=yes\");'>");
		/*if (light==1){
		...
		document.write("<img src='"+img+"'onload='allyes1()' border='0' ></a>");
		document.write("</div>");
	}
	else if (ns){
