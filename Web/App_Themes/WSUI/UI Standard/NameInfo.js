var MessageRoot = "http://ws-mzw-01/Messages.Web";
var AddressBookRoot = "http://ws-mzw-01/AddressBook";
var LCSRoot = "http://wws-mzw-01/LCSQuery.Web";
var CalendarRoot = "http://ws-mzw-01/Calendar.Web";

var UI_Root = "http://ws-mzw-01/";


var oPopup = window.createPopup();  
oPopup.document.createStyleSheet().addImport(UI_Root + "/Style/CSS/Css.css");
...
var divTemplate = "<div class='_0_' id='div_1_' width='100%'>"+
                ...
                "<div class='_11_'><span style='display:_17_;'><img src='" + UI_Root + "/UI Standard/Icon/Action/mail.gif' width='16' height='16' align='absmiddle' alt='发送EMAIL给他' id=\"imgSendMail_1_\" />"+
                "&nbsp;&nbsp;</span><span style='display:_12_;'><img src='" + UI_Root + "/UI Standard/Icon/Action/mobile.gif' width='16' height='16' align='absmiddle' alt='发送短信给他' id=\"imgSendSMS_1_\"/>&nbsp;&nbsp;</span>"+
                "<span style='display:_15_;'><img src='" + UI_Root + "/UI Standard/Icon/Action/lcs.gif' width='16' height='16' align='absmiddle' alt='和他在线聊天' id=\"imgSendLCS_1_\"/>&nbsp;&nbsp;</span>"+
                 "<span><img src='" + UI_Root + "/UI Standard/Icon/action/add.gif' width='16' height='16' align='absmiddle' alt='加入个人群组' id=\"imgAddToPersonalGroup_1_\"/>&nbsp;&nbsp;</span></div>"+
...
function ShowAndHide(id)
{
    ...
    if(imgSendSMS != null)
    {
        ...
        {
            window.open(MessageRoot + '/User/SendSMS.aspx?ReceiverID='+nameSpan.userid);
        }
    }
    ...
    if(imgAddToPersonalGroup != null)
    {
   	imgAddToPersonalGroup.onclick = function()
    	{
        	var myURL = AddressBookRoot + '/PersonalGroupSelector.aspx?UserGuid='+nameSpan.userid;
...
function GetStatusIcon(sta)
{
    ...
    {
        case "Online":
            return UI_Root + "/Style/Images/online.gif";
        case "Offline":
            return UI_Root + "/Style/Images/offline.gif";
        case "Away":
            return UI_Root + "/Style/Images/away.gif";
        case "Busy":
            return UI_Root + "/Style/Images/busy.gif";
        default:
            return UI_Root + "/Style/Images/offline.gif";
    }
}
...
function GetIconStatus(icon)
{
    switch(icon)
    {
        case UI_Root + "/Style/Images/online.gif":
            return "在线";
        case UI_Root + "/Style/Images/offline.gif":
            return "离线";
        case UI_Root + "/Style/Images/away.gif":
            return "离开";
        case UI_Root + "/Style/Images/busy.gif":
            return "忙碌";
        default:
            return "离线";
    }
...
{       
	...
	var bHttp = false;     
    var nameSpan = document.getElementById("imgStatus"+id);
    var url = LCSRoot + "/QueryPresence.aspx?l=en&uri=" + nameSpan.lcs+"&nocache="+Math.random(); 
    var text = "";
    var s = "";
...
{       
	...
	var bHttp = false;     
    var nameSpan = document.getElementById("imgStatus"+id);
    var url = CalendarRoot + "/CalendarUserStatus.aspx?UserID=" + nameSpan.userid+"&nocache="+Math.random(); 
