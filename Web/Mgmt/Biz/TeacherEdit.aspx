<%@ Page Title="老师编辑" Language="C#" MasterPageFile="~/MasterPage/Edit.Master" AutoEventWireup="true" CodeBehind="TeacherEdit.aspx.cs" Inherits="CourseMgmt.Web.Mgmt.Biz.TeacherEdit" %>
        ...
        <ContentTemplate>
            <asp:PlaceHolder runat="server" ID="phData">
                <table cellpadding="5" border="0" class="TableFormB" valign="top" width="100%">
                    <tr>
                        <th class="required" width="200">工号
                        </th>
                        <td>
            ...
            <div style="text-align: center; margin-top: 5px;">
                ...
                <input type="button" class="Button04" onclick="location.href = 'TeacherList.aspx';" value="取消" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
