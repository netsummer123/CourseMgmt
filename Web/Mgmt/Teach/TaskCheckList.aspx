<%@ Page Title="校对成绩" Language="C#" MasterPageFile="~/MasterPage/ListLarge.Master" CodeBehind="TaskCheckList.aspx.cs" Inherits="CourseMgmt.Web.Mgmt.Teach.TaskCheckList" %>
                            ...
                            <table cellspacing="0" cellpadding="0" border="0" class="TableFormA">
                                ...
                                <tr>
                                    <td>&nbsp;&nbsp; 
                                        ...
                                        &nbsp;&nbsp;<asp:Button runat="server" ID="btnSearch" CssClass="Button03" Style="width: 44px;" Text="计算" OnClick="btnSearch_Click"></asp:Button>
                                    </td>
                                </tr>
                            </table>
                        </asp:PlaceHolder>
                            ...
                            <asp:Repeater ID="rpList" runat="server" OnItemCommand="rpList_ItemCommand" OnItemDataBound="rpList_OnItemDataBound">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="align-center" colspan="2"><%# Eval("RoutineScore1","{0:0}") %>
                                        </td>
                                        <td class="align-center" colspan="3"><%# Eval("RoutineScore2","{0:0}") %>
                                        </td>
                                        <td class="align-center" colspan="4"><%# Eval("RoutineScore3","{0:0}") %>
                                        </td>
                                        <td class="align-center" colspan="3"><%# Eval("TaskScore1","{0:0}") %>
                                        </td>
                                        <td class="align-center" colspan="3"><%# Eval("TaskScore2","{0:0}") %>
                                        </td>
                                        <td class="align-center" colspan="3"><%# Eval("TaskScore3","{0:0}") %>
                                        </td>
                                        <td class="align-center" colspan="3"><%# Eval("RoutineScore4","{0:0}") %>
                                        </td>
                                        <td class="align-center" colspan="3"><%# Eval("TaskScore4","{0:0}") %>
                                        </td>
                                        <td class="align-center" colspan="3"><%# Eval("TaskScore5","{0:0}") %>
                                        </td>
                                        <td class="align-center" colspan="3"><%# Eval("TaskScore6","{0:0}") %>
                                        </td>
                                        <td class="align-center" colspan="3"><%# Eval("TaskScore7","{0:0}") %>
                                        </td>
                                        <td class="align-center"><%# Eval("FinalScore","{0:0}") %>
                                        </td>
                                        <td class="align-center">
                                            <asp:PlaceHolder runat="server" ID="phItemOp" Visible="False">&nbsp;
                                                <a class="fancybox link-edit" href='TaskCheckEdit.aspx?CourseID=<%# Eval("CourseID") %>&StudentID=<%# Eval("StudentID") %>' title="手工打分">手工打分</a>
                                            </asp:PlaceHolder>
                                        </td>
                                    </tr>
                                </ItemTemplate>
