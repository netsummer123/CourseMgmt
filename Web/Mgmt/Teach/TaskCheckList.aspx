<%@ Page Title="校对成绩" Language="C#" MasterPageFile="~/MasterPage/List.Master" CodeBehind="TaskCheckList.aspx.cs" Inherits="CourseMgmt.Web.Mgmt.Teach.TaskCheckList" %>
                            ...
                            <asp:Repeater ID="rpList" runat="server" OnItemCommand="rpList_ItemCommand" OnItemDataBound="rpList_OnItemDataBound">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="align-center"><%# Eval("RoutineScore1","{0:0}") %>
                                        </td>
                                        <td class="align-center"><%# Eval("RoutineScore2","{0:0}") %>
                                        </td>
                                        <td class="align-center"><%# Eval("RoutineScore3","{0:0}") %>
                                        </td>
                                        <td class="align-center"><%# Eval("TaskScore1","{0:0}") %>
                                        </td>
                                        <td class="align-center"><%# Eval("TaskScore2","{0:0}") %>
                                        </td>
                                        <td class="align-center"><%# Eval("TaskScore3","{0:0}") %>
                                        </td>
                                        <td class="align-center"><%# Eval("RoutineScore4","{0:0}") %>
                                        </td>
                                        <td class="align-center"><%# Eval("TaskScore4","{0:0}") %>
                                        </td>
                                        <td class="align-center"><%# Eval("TaskScore5","{0:0}") %>
                                        </td>
                                        <td class="align-center"><%# Eval("TaskScore6","{0:0}") %>
                                        </td>
                                        <td class="align-center"><%# Eval("TaskScore7","{0:0}") %>
                                        </td>
