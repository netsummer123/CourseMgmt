<%@ Page Title="查看作业" Language="C#" MasterPageFile="~/MasterPage/Edit.Master" AutoEventWireup="true" CodeBehind="TaskView.aspx.cs" Inherits="CourseMgmt.Web.Mgmt.Stu.TaskView" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div style="text-align: center; margin-top: 5px;">
                <input type="button" class="Button04" onclick="location.href = 'TaskList.aspx';" value="返回" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
